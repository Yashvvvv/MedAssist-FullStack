...
import com.medassist.common.dto.ApiErrorResponse;
import com.medassist.pharmacy.dto.PharmacyLocationRequest;
import com.medassist.pharmacy.dto.PharmacyLocationResponse;
import com.medassist.pharmacy.service.PharmacyLocationService;
...
@Slf4j
@RestController
@RequestMapping("/api/v1/pharmacies/location")
...
public class PharmacyLocationController {
    ...
    public CompletableFuture<ResponseEntity<List<PharmacyLocationResponse>>> findNearbyPharmacies(
        ...
        log.info("Finding nearby pharmacies for lat: {}, lon: {}",
        ...
        return result.thenApply(response -> {
            if (response instanceof List) {
                ...
                log.warn("Find nearby pharmacies returned unexpected result type");
                return ResponseEntity.<List<PharmacyLocationResponse>>status(HttpStatus.NO_CONTENT).build();
            }
        }).exceptionally(throwable -> {
            log.error("Error finding nearby pharmacies", throwable);
    ...
    public CompletableFuture<ResponseEntity<List<PharmacyLocationResponse>>> findNearbyPharmaciesGet(
        ...
        log.info("Finding nearby pharmacies (GET) for lat: {}, lon: {}", latitude, longitude);
    ...
    public CompletableFuture<ResponseEntity<List<PharmacyLocationResponse>>> findPharmaciesWithMedicine(
        ...
        log.info("Finding pharmacies with medicine: {} near lat: {}, lon: {}",
        ...
        return result.thenApply(response -> {
            if (response instanceof List) {
                ...
                log.warn("Find pharmacies with medicine returned unexpected result type");
                return ResponseEntity.<List<PharmacyLocationResponse>>status(HttpStatus.NO_CONTENT).build();
            }
        }).exceptionally(throwable -> {
            log.error("Error finding pharmacies with medicine", throwable);
            return ResponseEntity.<List<PharmacyLocationResponse>>status(HttpStatus.INTERNAL_SERVER_ERROR).build();
        });
    }
    ...
    public CompletableFuture<ResponseEntity<PharmacyLocationResponse>> getPharmacyLocationDetails(
        ...
        log.info("Getting location details for pharmacy ID: {}", pharmacyId);
        ...
        return result.thenApply(response -> {
            if (response instanceof PharmacyLocationResponse) {
                ...
                log.warn("Get pharmacy location details returned unexpected result type");
                return ResponseEntity.<PharmacyLocationResponse>status(HttpStatus.NO_CONTENT).build();
            }
        }).exceptionally(throwable -> {
            log.error("Error getting pharmacy location details", throwable);
    ...
    public CompletableFuture<ResponseEntity<List<PharmacyLocationResponse>>> findOpenPharmacies(
        ...
        log.info("Finding open pharmacies near lat: {}, lon: {}", latitude, longitude);
    ...
    public CompletableFuture<ResponseEntity<List<PharmacyLocationResponse>>> find24HourPharmacies(
        ...
        log.info("Finding 24-hour pharmacies near lat: {}, lon: {}", latitude, longitude);
    ...
    public CompletableFuture<ResponseEntity<List<PharmacyLocationResponse>>> findPharmaciesWithDelivery(
        ...
        log.info("Finding pharmacies with delivery near lat: {}, lon: {}", latitude, longitude);
    ...
    public CompletableFuture<ResponseEntity<List<PharmacyLocationResponse>>> findPharmaciesWithDriveThrough(
        ...
        log.info("Finding pharmacies with drive-through near lat: {}, lon: {}", latitude, longitude);
    ...
    public CompletableFuture<ResponseEntity<List<PharmacyLocationResponse>>> findPharmaciesByChain(
        ...
        log.info("Finding {} pharmacies near lat: {}, lon: {}", chainName, latitude, longitude);
