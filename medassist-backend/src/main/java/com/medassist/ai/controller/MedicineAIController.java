...
import com.medassist.medicine.dto.MedicineAnalysisResponse;
import com.medassist.ai.service.MedicineAIService;
...
@RestController
@RequestMapping("/api/v1/ai/medicine")
@Validated
...
public class MedicineAIController {
    ...
    public CompletableFuture<ResponseEntity<MedicineAnalysisResponse>> analyzeMedicineByImage(
            @RequestParam("file") @NotNull(message = "Image file is required") MultipartFile file) {
    ...
    public CompletableFuture<ResponseEntity<MedicineAnalysisResponse>> analyzeMedicineCombined(
            @RequestParam @NotBlank(message = "Query cannot be blank") String query,
            @RequestParam("image") @NotNull(message = "Image file is required") MultipartFile imageFile) {
    ...
    public CompletableFuture<ResponseEntity<MedicineAnalysisResponse>> analyzeDrugInteractions(
            @RequestParam @NotBlank(message = "Primary medicine cannot be blank") String primaryMedicine,
            @RequestParam @NotNull(message = "Other medicines list is required") List<String> otherMedicines) {
