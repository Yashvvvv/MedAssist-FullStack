...
class MedicineServiceTest {
    ...
    void testUpdateMedicine_NotFound() {
        ...
        // When & Then
        assertThrows(ResourceNotFoundException.class, () -> medicineService.updateMedicine(999L, updatedMedicine));
        verify(medicineRepository, times(1)).findById(999L);
    ...
    void testDeleteMedicine_NotFound() {
        ...
        // When & Then
        assertThrows(ResourceNotFoundException.class, () -> medicineService.deleteMedicine(999L));
